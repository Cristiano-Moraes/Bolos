...
public class CustomPesoAdapter extends BaseAdapter {

    private ArrayList<String> listProdutos;
    private String[] produtos;
    Context ctx;

    public CustomPesoAdapter(Context context, String[]p){
        this.ctx = context;
        this.produtos = p;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.custom_item_peso_cell, parent, false);
